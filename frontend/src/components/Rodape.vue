...
<template>
    <div class="fixed left-0 right-0 bottom-10 px-5">
        <div class="flex justify-center bg-zinc-900 items-center py-5 rounded-full">
            <ul class="flex text-white gap-5 ">
                <li class="botao w-20">
                    <a href="">
                        <div class="flex flex-col items-center">
                            <svg width="30" height="30" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9 0L3 2V14H1V16H15V14H13V2H11V14H9V0ZM6.75 9C7.16421 9 7.5 8.55229 7.5 8C7.5 7.44772 7.16421 7 6.75 7C6.33579 7 6 7.44772 6 8C6 8.55229 6.33579 9 6.75 9Z" fill="currentColor"/>
                            </svg>
                            Início
                        </div>
                    </a>
